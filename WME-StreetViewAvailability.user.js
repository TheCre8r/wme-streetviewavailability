...
(function() {
  ...
  function init(e) {
    ...
    var streetViewLayer = new OpenLayers.Layer.XYZ('Street View', tilelayerServers[Math.floor(Math.random() * tilelayerServers.length)] + '?lyrs=svv&x=${x}&y=${y}&z=${z}&w=256&h=256&style=40', {
      isBaseLayer: false,
